...
import com.mycompany.consultas.CategoriaConsultas;
...
public class indexController implements Serializable{
    ...
    public void crearUsuario() throws NoSuchAlgorithmException{        
        DTO_Usuario us;
        us = usuarioInterface.validaCorreo(correo);
        if(us == null){
            String contrasena = contraseña(clave);
            DTO_Usuario usuario = new DTO_Usuario(0, nombre, correo, contrasena);
    ...
    @EJB
    CategoriaConsultas categoriaCon;
